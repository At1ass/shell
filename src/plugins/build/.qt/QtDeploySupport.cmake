...
if(NOT QT_DEPLOY_BIN_DIR)
    set(QT_DEPLOY_BIN_DIR "usr/bin")
endif()
if(NOT QT_DEPLOY_LIBEXEC_DIR)
    set(QT_DEPLOY_LIBEXEC_DIR "usr/libexec")
endif()
if(NOT QT_DEPLOY_LIB_DIR)
    set(QT_DEPLOY_LIB_DIR "usr/lib")
endif()
...
set(__QT_DEPLOY_IMPL_DIR "/home/at1ass/.config/quickshell/shell/src/plugins/build/.qt")
...
set(__qt_deploy_support_files
    "/home/at1ass/.config/quickshell/shell/src/plugins/build/.qt/QtDeployTargets.cmake"
